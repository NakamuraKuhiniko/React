...
// 字符串模版
var template = exports.template = function template(tpl, data) {
  var re = /<%([^%>]+)?%>/g;
...
require('../lib/materialize/js/materialize');
...
var _projects = require('../../projects.yaml');

var _projects2 = _interopRequireDefault(_projects);

var _stars = require('../../stars.json');
...
function renderPage() {
  ...
  renderComponent('siderMenu', '.app-sider-menu', {
    category: Object.keys(_projects2.default)
  });
